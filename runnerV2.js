...
define(["require", 'jquery', "base/js/namespace", "base/js/dialog", './bloxbergAPI', './etnyContract', './ipfs', './certificate', './cell', './crypto', './utils'], function (require, $, Jupyter, dialog, bloxbergAPI, etnyContract, ipfs, certificate, cells, crypto, utils) {
    ...
    console.log('hey');
    const VERSION = 'v2';
    const ENCLAVE_IMAGE_IPFS_HASH = 'QmcNgmnWKzmEkukTTbsk7Dedc2XW75E5NkrsCTjTgcNKyM';
    ...
    gTcT0l/4ulDX5GJ7kuDeDH/ReepLaimOlcWpY7YBHwFdMtY++LjMh6MXMBUwEwYD
    VR0lBAwwCgYIKwYBBQUHAwEwCgYIKoZIzj0EAwMDaAAwZQIwcMoiEGLbL2PyGJkV
    dpeESCLTYy88PDAOqitIKkolg4QEJvpExytXzVk2oykTyPTuAjEA0Zna+9FCqbd+
    JeMcdqniiJUBFGQi/O0vV6GB4rHDqSHMETjXv/2zFMP4NHlMt28w
    -----END CERTIFICATE-----`;
