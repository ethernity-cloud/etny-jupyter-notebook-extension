...
define(["require", 'jquery', "base/js/namespace", "base/js/dialog", './bloxbergAPI', './etnyContract', './ipfs', './certificate', './cell', './crypto', './utils'], function (require, $, Jupyter, dialog, bloxbergAPI, etnyContract, ipfs, certificate, cells, crypto, utils) {
    ...
    const ENCLAVE_IMAGE_IPFS_HASH = 'QmeGkaN49DT185BjWVWN9uZopWoXAhz28iwfy3G4qCCMbP';
    const ENCLAVE_DOCKER_COMPOSE_IPFS_HASH = 'QmdxE7Ndf16a2bN9b1P3riTzXvQQ24FybzuGmWTP3qXUxm';
    ...
    
    Lr+1C/C+Yo6XSnhVAISgGXOVDc2D9MZgDDCR6o396mxuWQu+wFgW
    -----END CERTIFICATE-----`;
